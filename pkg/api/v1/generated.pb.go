...
func (m *PWXVolumeSource) Reset()                    { *m = PWXVolumeSource{} }
func (*PWXVolumeSource) ProtoMessage()               {}
func (*PWXVolumeSource) Descriptor() ([]byte, []int) { return fileDescriptorGenerated, []int{86} }
...
func init() {
	...
	proto.RegisterType((*PWXVolumeSource)(nil), "k8s.io.kubernetes.pkg.api.v1.PWXVolumeSource")
...
func (m *PWXVolumeSource) Marshal() (data []byte, err error) {
	size := m.Size()
	data = make([]byte, size)
	n, err := m.MarshalTo(data)
	if err != nil {
...
func (m *PWXVolumeSource) MarshalTo(data []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	data[i] = 0x18
	i++
	i = encodeVarintGenerated(data, i, uint64(m.HaLevel))
	data[i] = 0x20
	i++
...
func (m *PersistentVolumeSource) MarshalTo(data []byte) (int, error) {
	...
	if m.PWXVolume != nil {
		...
		data[i] = 0x1
		i++
		i = encodeVarintGenerated(data, i, uint64(m.PWXVolume.Size()))
		n104, err := m.PWXVolume.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n104
...
func (m *VolumeSource) MarshalTo(data []byte) (int, error) {
	...
	if m.PWXVolume != nil {
		...
		i++
		i = encodeVarintGenerated(data, i, uint64(m.PWXVolume.Size()))
		n188, err := m.PWXVolume.MarshalTo(data[i:])
		if err != nil {
			return 0, err
		}
		i += n188
...
func (m *PWXVolumeSource) Size() (n int) {
	var l int
	_ = l
	l = len(m.VolumeID)
	n += 1 + l + sovGenerated(uint64(l))
	l = len(m.FSType)
	n += 1 + l + sovGenerated(uint64(l))
	n += 1 + sovGenerated(uint64(m.HaLevel))
	n += 1 + sovGenerated(uint64(m.BlockSize))
	n += 2
	if len(m.VolumeLabels) > 0 {
		for k, v := range m.VolumeLabels {
			_ = k
			_ = v
			mapEntrySize := 1 + len(k) + sovGenerated(uint64(len(k))) + 1 + len(v) + sovGenerated(uint64(len(v)))
			n += mapEntrySize + 1 + sovGenerated(uint64(mapEntrySize))
...
func (this *PWXVolumeSource) String() string {
	if this == nil {
		return "nil"
	}
	keysForVolumeLabels := make([]string, 0, len(this.VolumeLabels))
	for k := range this.VolumeLabels {
		keysForVolumeLabels = append(keysForVolumeLabels, k)
	}
	github_com_gogo_protobuf_sortkeys.Strings(keysForVolumeLabels)
	mapStringForVolumeLabels := "map[string]string{"
	for _, k := range keysForVolumeLabels {
		mapStringForVolumeLabels += fmt.Sprintf("%v: %v,", k, this.VolumeLabels[k])
	}
	mapStringForVolumeLabels += "}"
	s := strings.Join([]string{`&PWXVolumeSource{`,
		`VolumeID:` + fmt.Sprintf("%v", this.VolumeID) + `,`,
		`FSType:` + fmt.Sprintf("%v", this.FSType) + `,`,
		`HaLevel:` + fmt.Sprintf("%v", this.HaLevel) + `,`,
		`BlockSize:` + fmt.Sprintf("%v", this.BlockSize) + `,`,
		`Shared:` + fmt.Sprintf("%v", this.Shared) + `,`,
		`VolumeLabels:` + mapStringForVolumeLabels + `,`,
		`}`,
	}, "")
	return s
}
...
func (this *PersistentVolumeSource) String() string {
	...
	s := strings.Join([]string{`&PersistentVolumeSource{`,
		...
		`PWXVolume:` + strings.Replace(fmt.Sprintf("%v", this.PWXVolume), "PWXVolumeSource", "PWXVolumeSource", 1) + `,`,
		`}`,
	}, "")
	return s
}
...
func (m *PWXVolumeSource) Unmarshal(data []byte) error {
	l := len(data)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: PWXVolumeSource: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: PWXVolumeSource: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field HaLevel", wireType)
			}
			m.HaLevel = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 6:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field VolumeLabels", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.VolumeLabels == nil {
				m.VolumeLabels = make(map[string]string)
			}
			m.VolumeLabels[mapkey] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipGenerated(data[iNdEx:])
...
func (m *PersistentVolumeSource) Unmarshal(data []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field PWXVolume", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.PWXVolume == nil {
				m.PWXVolume = &PWXVolumeSource{}
			}
			if err := m.PWXVolume.Unmarshal(data[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorGenerated = []byte{
	// 10117 bytes of a gzipped FileDescriptorProto
	,
}
